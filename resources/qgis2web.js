...
map.getView().fit([-424470.504401, 1176874.101077, 117259.689008, 1459389.954190], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">DESCRIPTION DE LA DENSITE DE LA REGION DE NANDO</h2>';
        return titleElement;
    })(),
